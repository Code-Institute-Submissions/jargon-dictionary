...
application.config["MONGO_DBNAME"] = "jargon-dictionary"
application.config["MONGO_URI"] = os.getenv("JARGON_URI")
...
@application.route('/get_definitions/<category>')
...
@application.route('/edit_definition/<definition_id>')
...
@application.route('/update_definition/<definition_id>', methods=["POST"])
...
@application.route('/delete_definition/<definition_id>')
...
@application.route('/edit_deck/<deck_id>')
...
@application.route('/update_deck/<deck>', methods=["POST"])
...
@application.route('/delete_deck/<deck_id>')
